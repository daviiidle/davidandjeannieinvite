...
const appRoutes = [
  'save-the-date-2026',
  path.join('en', 'save-the-date-2026'),
  path.join('vi', 'save-the-date-2026'),
];
...
const metaByLocale = {
  en: {
    ...
    url: 'https://davidandjeanniewedding.site/en/save-the-date-2026',
    locale: 'en_AU',
  ...
  vi: {
    ...
    url: 'https://davidandjeanniewedding.site/vi/save-the-date-2026',
    locale: 'vi_VN',
...
const applyMeta = (html, meta) => {
  const replacements = [
    ...
    [/rel="canonical" href="[^"]*"/, `rel="canonical" href="${meta.url}"`],
...
fs.writeFileSync(path.join(distDir, 'index.html'), redirectTemplate('/en/save-the-date-2026'));
...
fs.writeFileSync(path.join(enDir, 'index.html'), redirectTemplate('/en/save-the-date-2026'));
fs.writeFileSync(path.join(viDir, 'index.html'), redirectTemplate('/vi/save-the-date-2026'));
